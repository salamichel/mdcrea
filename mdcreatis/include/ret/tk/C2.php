...
<section id="SC_ret_tck" class="F1 R5 M20">
	...
	<div class="sl-slider">
		...
		<article class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
			<div class="UCP">
				<img src="css/ret/C2/C2_1r.jpg">
				<img src="css/ret/C2/C2_1.jpg">		
			</div>
		</article>
		...
		<article class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
			<div class="UCP">
				<img src="css/ret/C2/C2_2r.jpg">
				<img src="css/ret/C2/C2_2.jpg">		
			</div>
		</article>
		...
		<article class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
			<div class="UCP">
				<img src="css/ret/C2/C2_3r.jpg">
				<img src="css/ret/C2/C2_3.jpg">		
			</div>
		</article>
		...
		<article class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
			<div class="UCP">
				<img src="css/ret/C2/C2_4r.jpg">
				<img src="css/ret/C2/C2_4.jpg">		
			</div>
		</article>

		<article class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
			<div class="UCP">
				<img src="css/ret/C2/C2_5r.jpg">
				<img src="css/ret/C2/C2_5.jpg">		
			</div>
		</article>

		<article class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
			<div class="UCP">
				<img src="css/ret/C2/C2_6r.jpg">
				<img src="css/ret/C2/C2_6.jpg">		
			</div>
		</article>
	...
	<div class="T_1 CLR">
		...
		<article>
			...
			<h2>Réduction Lumineuse</h2>
			<p>Une image trop lumineuse peut blanchir certaines parties d'une photo et en faire disparaitre les détails. Cette retouche permet de régler le problème de sur-exposition de l'image en diminuant la luminosité globale de la composition et en récupérant les détails.</p>
			<ul class="CLR">
