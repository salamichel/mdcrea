...
<section id="SC_ret_tck" class="F1 R5 M20">
	...
	<div class="sl-slider">
		...
		<article class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
			<div class="UCP">
				<img src="css/ret/C1/C1_1r.jpg">
				<img src="css/ret/C1/C1_1.jpg">		
			</div>
		</article>
		...
		<article class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
			<div class="UCP">
				<img src="css/ret/C1/C1_2r.jpg">
				<img src="css/ret/C1/C1_2.jpg">		
			</div>
		</article>
		...
		<article class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
			<div class="UCP">
				<img src="css/ret/C1/C1_3r.jpg">
				<img src="css/ret/C1/C1_3.jpg">		
			</div>
		</article>
		...
		<article class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
			<div class="UCP">
				<img src="css/ret/C1/C1_4r.jpg">
				<img src="css/ret/C1/C1_4.jpg">		
			</div>
		</article>

		<article class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
			<div class="UCP">
				<img src="css/ret/C1/C1_5r.jpg">
				<img src="css/ret/C1/C1_5.jpg">		
			</div>
		</article>

		<article class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
			<div class="UCP">
				<img src="css/ret/C1/C1_6r.jpg">
				<img src="css/ret/C1/C1_6.jpg">		
			</div>
		</article>
	...
	<div class="T_1 CLR">
		...
		<article>
			...
			<h2>Augmentation Lumineuse</h2>
			<p>Une image trop sombre fait disparaitre certains détails d'une photographie. Cette retouche permet de régler le problème de sous-exposition de l'image en augmentant la luminosité globale de la composition.</p>
			<ul class="CLR">
