...
<section id="SC_ret_ad" class="F1 R5 M20">
	...
	<div class="BK_UCP">
		<div class="UCP">
			<img src="css/ret/A0/A0_4r.jpg">
			<img src="css/ret/A0/A0_4.jpg">
		</div>
	</div>
	...
	<div class="T_1 CLR">
		...
		<article>
			...
			<h1>La Faible luminosité</h1>
			<h2>L'environnement d'une photo peut conduire à une photo trop sombre (sous-exposée), altérant ainsi ses détails.</h2>
			<p>Une trop faible luminosité réduit la surface de détails d’une photo. En général, elle est du à un environnement dépourvu
