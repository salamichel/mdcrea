...
<section id="SC_ret_pk" class="FD R5 M20">
	...
	<div class="T_2 CLR">
		...
		<article>
			...
			<h1>Pack Paint</h1>
			<h2>Gravez des souvenirs en photo est un fait, mais les peindre sur une toile, c'est un tout autre charme.</h2>
			<p>Un pack spécialement conçu pour retranscrire d'une photo, son modèle sur peinture. Retoucher la photo originale et la peindre sur une toile.</p>
