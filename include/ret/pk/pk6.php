...
<section id="SC_ret_pk" class="FD R5 M20">
	...
	<div class="T_2 CLR">
		...
		<article>
			...
			<p>Un Pack ultime pour la dé saturation partielle de vos photos. Mettre en valeur un ou des éléments précis de votre photo deviendra un jeu d'enfant.</p>
			...
			<div>
				...
				<p>€ 8,99 TTC <span>au lieu de </span><span>15,26 €</span></p>
		...
		<ul>
			...
			<li><a href="index.php?page=retouch_B4" class="FHb">
				<h2>Correction COLORIMÉTRIE<span>Dé Saturation Partielle</span></h2>
			</a></li>
			<li><a href="index.php?page=retouch_A2" class="FHb">
