...
<section id="SC_ret_pk" class="FD R5 M20">
	...
	<div class="T_2 CLR">
		...
		<article>
			...
			<h2>Partager ses émotions au détour d'un souvenir démuni de couleurs. Box B & White (Portrait) associe le dynamisme et le prestige d'une photographie en noir et blanc pour portrait.</h2>
			<p>Conçu pour la photo en noir et blanc. Il permet de gommer les imperfections d'un portrait et de donner un charme d'antan avec beaucoup plus de profondeur.</p>
			...
			<div>
				...
				<p>€ 6,49 TTC <span>au lieu de </span><span>11,46 €</span></p>
